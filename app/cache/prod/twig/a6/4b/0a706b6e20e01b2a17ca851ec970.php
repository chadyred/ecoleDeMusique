...
<div id=\"page\">
    <div>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["tab"]) ? $context["tab"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["tabeuh"]) {
            // line 61
            echo "                        <tr>
                            <td class=\"colonneId\"><a href=\"";
            // line 62
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("famille_membre", array("id" => $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "id"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "id"), "html", null, true);
            echo "</a></td>
                            <td class=\"colonneQf\">";
            // line 63
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "qf"), "html", null, true);
            echo "</td>
                            <td class=\"colonneMembre\"> ";
            // line 64
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "noms"), "html", null, true);
            echo "</td>
                            <td class=\"colonneMembre\"> ";
            // line 65
            if ($this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "nom")) {
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "nom"), "html", null, true);
            }
            echo "</td>
                            <td class=\"colonneMembre\"> ";
            // line 66
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "prenom"), "html", null, true);
            echo "</td>                                                
                            <td>
                                <a href=\"";
            // line 68
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("famille_edit", array("id" => $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "id"))), "html", null, true);
            echo "\"><img src=\"";
            ...
            echo "\"></a>
                            ...
                            <td>
                                <a href=\"";
            // line 72
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("famille_delete", array("id" => $this->getAttribute((isset($context["tabeuh"]) ? $context["tabeuh"] : null), "id"))), "html", null, true);
