...
class Mailing extends \EcoleDeMusique\WelcomeBundle\Entity\Mailing implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Mailing' . "\0" . 'id', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Mailing' . "\0" . 'titre', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Mailing' . "\0" . 'message', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Mailing' . "\0" . 'nomActivite', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Mailing' . "\0" . 'activiteEleves');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mailing $proxy) {
    ...
    public function getActiviteEleves()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActiviteEleves', array());
    ...
    public function addActiviteEleves(\EcoleDeMusique\WelcomeBundle\Entity\Mailing $activiteEleves)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addActiviteEleves', array($activiteEleves));
    ...
    public function removeActiviteEleves(\EcoleDeMusique\WelcomeBundle\Entity\Mailing $activiteEleves)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeActiviteEleves', array($activiteEleves));
