 ...
 */
class Salle extends \EcoleDeMusique\WelcomeBundle\Entity\Salle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Salle' . "\0" . 'id', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Salle' . "\0" . 'nom', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\Salle' . "\0" . 'salles');
        }
    ...
    public function addSalle(\EcoleDeMusique\WelcomeBundle\Entity\Salle $salles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSalle', array($salles));

        return parent::addSalle($salles);
    }
