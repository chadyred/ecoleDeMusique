 ...
 */
class ActiviteEleve extends \EcoleDeMusique\WelcomeBundle\Entity\ActiviteEleve implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActiviteEleve $proxy) {
    ...
    public function getMailing()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMailing', array());
