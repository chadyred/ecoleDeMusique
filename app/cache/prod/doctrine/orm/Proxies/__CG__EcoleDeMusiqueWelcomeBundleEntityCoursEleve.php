...
class CoursEleve extends \EcoleDeMusique\WelcomeBundle\Entity\CoursEleve implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\CoursEleve' . "\0" . 'id', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\CoursEleve' . "\0" . 'cours', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\CoursEleve' . "\0" . 'eleve');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CoursEleve $proxy) {
