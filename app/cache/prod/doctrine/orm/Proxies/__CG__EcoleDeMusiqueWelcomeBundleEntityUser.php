 ...
 */
class User extends \EcoleDeMusique\WelcomeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\User' . "\0" . 'login', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\User' . "\0" . 'mdp', '' . "\0" . 'EcoleDeMusique\\WelcomeBundle\\Entity\\User' . "\0" . 'role');
        }
