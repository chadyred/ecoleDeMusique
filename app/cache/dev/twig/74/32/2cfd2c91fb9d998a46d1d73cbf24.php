...
class __TwigTemplate_74322cfd2c91fb9d998a46d1d73cbf24 extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
       ...
       <div id=\"header\">
                                                   ...
                                                   <td>
                                                    ...
                                                    <td>
                                                      <select id=\"ecoledemusique_welcomebundle_courstype_activite\" name=\"ecoledemusique_welcomebundle_courstype[activite]\">
                                                        ...
                                                        ";
        // line 146
        if (twig_test_empty($this->getContext($context, "listeActivite"))) {
            // line 147
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listeActivite"]) {
                ...
                echo "\" ";
                if ($this->getAttribute($this->getContext($context, "control", true), "activite", array(), "any", true, true)) {
        ...
        // line 164
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "listeEleve"));
        foreach ($context['_seq'] as $context["_key"] => $context["listeEleve"]) {
            // line 165
            echo "                                                                <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listeEleve"), "id"), "html", null, true);
            echo "\" ";
            if (($this->getAttribute($this->getContext($context, "listeEleve"), "id") == $this->getAttribute($this->getContext($context, "control"), "eleve"))) {
                echo " selected";
            }
            echo ">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listeEleve"), "nom"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listeEleve"), "prenom"), "html", null, true);
            echo "</option>
                                                        ";
        }
        $_parent = $context['_parent'];
