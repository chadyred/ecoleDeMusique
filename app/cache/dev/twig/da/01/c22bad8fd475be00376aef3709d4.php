...
class __TwigTemplate_da01c22bad8fd475be00376aef3709d4 extends Twig_Template
{
...
\t</div>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "eleves"));
        foreach ($context['_seq'] as $context["_key"] => $context["eleves"]) {
            // line 28
            echo "                                                     <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "eleves"), "id"), "html", null, true);
            echo "\" ";
            if (($this->getAttribute($this->getContext($context, "eleves"), "regie") == null)) {
                echo " style=\"color:red;\"";
            }
            echo ">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "eleves"), "nom"), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "eleves"), "prenom"), "html", null, true);
            echo "</option> <br />
                                                    ";
        }
        ...
        echo "      
                                        ...
                                        <div>
                                                    ...
                                                    ";
        // line 69
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "anneDeCours"), 'label', (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("Annee scolaire :")) ? array() : array("label" => $_label_)));
        echo "
                                         
                                                    ";
        // line 71
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getContext($context, "form"), "anneDeCours"), 'widget');
        echo "      
                                        </div> 
                                              <div>
                                              <br />
