...
class __TwigTemplate_13c8e447e7c5c16d529be855660ce8cc extends Twig_Template
{
...
\t</div>
        ...
        // line 26
        echo "  \t\t\t\t\t";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "activiteEleve"), 'label', array("label" => "Activité : "));
        echo "
                                        ";
        // line 28
        echo "                                        ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "activiteEleve"), 'errors');
        echo "
                                        ";
        // line 30
        echo "  \t\t\t\t\t";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "activiteEleve"), 'widget');
        echo "
                                        ";
        // line 31
...
\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["liste_mailing"]) ? $context["liste_mailing"] : $this->getContext($context, "liste_mailing")));
        foreach ($context['_seq'] as $context["_key"] => $context["mailing"]) {
            // line 41
            echo "                                        <tr><td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["mailing"]) ? $context["mailing"] : $this->getContext($context, "mailing")), "getTitre", array(), "method"), "html", null, true);
            echo "</td> <td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["mailing"]) ? $context["mailing"] : $this->getContext($context, "mailing")), "getMessage", array(), "method"), "html", null, true);
            echo "</td>  
                                            ";
            // line 42
            $context["activite_eleves"] = $this->getAttribute((isset($context["mailing"]) ? $context["mailing"] : $this->getContext($context, "mailing")), "getActiviteEleves", array(), "method");
            // line 43
            echo "                                                <td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["mailing"]) ? $context["mailing"] : $this->getContext($context, "mailing")), "getNomActivite", array(), "method"), "html", null, true);
            echo "</td>
                                                <td><a href=\"";
            // line 44
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("mailing_delete", array("id" => $this->getAttribute((isset($context["mailing"]) ? $context["mailing"] : $this->getContext($context, "mailing")), "getId", array(), "method"))), "html", null, true);
            echo "\"><img src=\"";
