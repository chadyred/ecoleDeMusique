...
/* EcoleDeMusiqueWelcomeBundle:Salle:index.html.twig */
class __TwigTemplate_e7494f1839dfe1391b400d3bc763d58d extends Twig_Template
{
...
\t</div>
            <div id=\"page\">
                  <div class=\"post\">
                       <h2 class=\"title\">Liste des Salles </h2>
                             <div class=\"entry\">
                                 <p>Liste des salles de l'établissement</p>
                                 <br />
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "</td>
                                                <td>
                                                            <a href=\"";
            // line 34
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("salle_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\"><img src=\"";
            ...
            echo "\"></a>
                                                  ...
                                                  <td>
                                                            <a href=\"";
            // line 37
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("salle_delete", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
            echo "\" onclick=\"return confirm('Êtes vous sur de vouloir supprimer cette salle?')\"><img src=\"";
...
";
    ...
    {
        return "EcoleDeMusiqueWelcomeBundle:Salle:index.html.twig";
    }
