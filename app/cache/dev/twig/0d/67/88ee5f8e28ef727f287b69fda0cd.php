...
/* EcoleDeMusiqueWelcomeBundle:ActiviteEleve:search.html.twig */
class __TwigTemplate_0d6788ee5f8e28ef727f287b69fda0cd extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        <div id=\"page\">
               <div id=\"content\">
                  <div class=\"post\">
                       <h2 class=\"title\">Recherches des Activites d'élèves </h2>
                             <div class=\"entry\">
                                 <p>Tapez les données exactes </p>
                                 <br />

                                        <form action=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("activiteeleve_searchResult"), "html", null, true);
        echo "\" method=\"post\" ";
        ...
        echo " 
                                           ...
                                           <tr>
                                                    ...
                                                    <td>
                                                            ";
        // line 43
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "pratique"), 'label', (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("pratique :")) ? array() : array("label" => $_label_)));
        echo "
                                                    </td>
                                                    <td>
                                                              ";
        // line 46
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "pratique"), 'widget');
        echo " 
                                                   </td>
                                           </tr>
                                           <tr>
                                                    <td>
                                                            ";
        // line 51
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "type"), 'label', (twig_test_empty($_label_ = $this->env->getExtension('translator')->trans("type(instru1..):")) ? array() : array("label" => $_label_)));
        echo "
                                                    </td>
                                                    <td>
                                                              ";
    ...
    {
        return "EcoleDeMusiqueWelcomeBundle:ActiviteEleve:search.html.twig";
    }
