...
class __TwigTemplate_7aa2a0573c70b965d24b8d0c6dd5c0b0 extends Twig_Template
{
...
\t</div>
        <div id=\"page\">
           <div id=\"content\">
                  <div class=\"post\">
                       <h2 class=\"title\">Création d'une nouvelle activité </h2>
                       
                       <p>Rentrer une Activité proposé par l'école avec sa categorie ! Par exemple pour un cours de violon <br />(nom : violon categorie : instrument)</p>
                       <br />
                             <div class=\"entry\">
                                    <form action=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("activite_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "EcoleDeMusiqueWelcomeBundle:Activite:new.html.twig";
    }
