...
/* EcoleDeMusiqueWelcomeBundle:Prof:new.html.twig */
class __TwigTemplate_703b603b15bc576f7127ed8c0d56b62c extends Twig_Template
{
...
\t</div>
          <div id=\"page\">
              ...
              <h1>Création d'un nouveau professeur</h1>
              <p>Vous pouvez ici ajouter un professeur à la base : </p>
                  ...
                  <div class=\"post\">
                        ...
                        <form action=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("prof_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "EcoleDeMusiqueWelcomeBundle:Prof:new.html.twig";
    }
